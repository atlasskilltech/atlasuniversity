...
$cycles = getAdmissionCyclesCon($conn, 3);
	...
	<tbody>
		<tr style="height: 33px" valign="middle">
			<td style="text-align: center;padding: 0" colspan="<?php echo $cyclesCount+1;?>">
				<div class="header-table" style="background-color: #009fe0;"><strong>B.Sc  (Hons.) Admissions Calendar for July 2026 Intake&nbsp;</strong></div>
			</td>
		</tr>
		<tr style="height: 33px" valign="middle">
		...
		<!--	<?php foreach ($cycles as $c) { ?>-->
  <!--                                          <td style="text-align: left;"><b><?php echo showDateUpdate($c['cycle_interview_date']); ?></b></td>-->
  <!--               <?php } ?> -->
       <!--  		 <td style="text-align: left;"><b>Closed</b></td>-->
			    <!--<td style="text-align: left;"><b>Closed</b></td>-->
