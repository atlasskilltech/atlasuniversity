<?php
$title = "B.Des Admissions – ATLAS ISDI";
$description = "Applying for B.Des? Explore specializations, eligibility, portfolio tips and start your design career today.";
...
<section class="course-cover-section">
	<div class="course-hero-wrapper">
		<div class="hero-text">
			<h1 class="h1-tag">B.Des <br />Admissions</h1>
...
<section id="eligibility" class="section">
	<div class="container">
		...
		<div data-hover="false" data-delay="0" data-w-id="8475acb7-4b0f-ef60-0a61-df5d860f56f9" style="height:80px" class="accordion-item-blue-fill w-dropdown">
			...
			<nav class="accordion-content-blue-fill w-dropdown-list">
				<div class="content-blue-fill w-richtext">
					<p>GCSE/IGCSE Examinations of the approved British Examination Bodies, with minimum 5 (Five) subjects in A, B, C, D and E grades, including English at Ordinary &#x27;O&#x27; Level and 2 subjects at Advanced &#x27;A&#x27; Level, has been equated with +2 stage qualification.</p>
				</div>
			</nav>
		</div>
