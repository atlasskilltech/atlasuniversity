<?php
$title = "Master's in Design Admissions – ATLAS ISDI";
$description = "Planning your M.Des? Explore postgraduate design courses, eligibility, portfolio needs and apply to boost your design career.";
$keywords = "atlas, contact";
$css = "atlass-fantastic-site-48323a.webflow.690ca47b295c3cd130e0a8a2-4738d5664.css";
$js = "https://cdn.prod.website-files.com/6846c77f346415bfcbb813b6/js/webflow.ee913841.9c23cc986ec5cec0.js";
$htmlDataId = "690ca47b295c3cd130e0a8a2";
$body = "body isdi-page";
...
<section class="course-cover-section">
	<div class="course-hero-wrapper">
		<div class="hero-text">
			<h1 class="h1-tag">M.Des <br />Admissions</h1>
...
<section id="key-dates" class="section">
   ...
   <!--         		<div class="df-txt-wrap"> <?php foreach ($cyclesISDIMDES as $c) { ?> <div class="df-text-2 f14"><?php echo showDate($c['cycle_app_open']); ?></div> <?php } ?> </div><img loading="lazy" src="https://cdn.prod.website-files.com/6846c77f346415bfcbb813b6/68e8e143b04dae2f58c2cef0_Polygon%202.png" alt="" class="image-8" />-->
   <!--         	</div>-->
            	<!--<div class="df-card">-->
            	<!--	<div class="df-text-2 f14">DAT exam & <br />Portfolio Submission</div> <?php foreach ($cyclesISDIMDES as $c) { ?> <div class="df-text-1 f18"><?php echo showDate($c['cycle_last_day_exam']); ?></div> <?php } ?>-->
            	<!--</div>-->
   <!--         	<div class="df-card">-->
   <!--         		<div class="df-text-2 f14">Personal Interview</div> <?php foreach ($cyclesISDIMDES as $c) { ?> <div class="df-text-1 f18"><?php echo showDate($c['cycle_interview_date']); ?></div> <?php } ?>-->
   <!--         	</div>-->
   <!--         	<div class="df-card">-->
   <!--         		<div class="df-text-2 f14">Result<br />Announcement</div> <?php foreach ($cyclesISDIMDES as $c) { ?> <div class="df-text-1 f18"><?php echo showDate($c['cycle_result']); ?></div> <?php } ?>-->
   <!--         	</div>-->
   <!--         	<div class="df-card">-->
   <!--         		<div class="df-text-2 f14">Acceptance Deadline</div> <?php foreach ($cyclesISDIMDES as $c) { ?> <div class="df-text-1 f18"><?php echo showDate($c['cycle_acceptance_deadline']); ?></div> <?php } ?>-->
   <!--         	</div>-->
   <!--         	<div class="df-card">-->
   <!--         		<div class="df-text-2 f14">Annual Fee Payment Deadline</div> <?php foreach ($cyclesISDIMDES as $c) { ?> <div class="df-text-1 f18"><?php echo showDate($c['cycle_sem_fee']); ?></div> <?php } ?>-->
   <!--         	</div>-->
   <!--     </div>       -->
        <?php
...
<section id="eligibility" class="section">
	<div class="container">
		...
		<div>
			<div class="ln-bd-txt">﻿﻿Students with a <strong>minimum of 4 years in an undergraduate degree program, regardless of the field,</strong> with at least 5<strong>0% aggregate marks</strong> from <strong>any university recognised by the AIU can apply.</strong> Those in their final year of study can also apply if they maintain a minimum 50% aggregate at graduation and have no live backlogs (ATKTs). <br /><br />Scor﻿﻿es from CEED, NIFT Entrance Exam, NID-DAT, GATE Exam are considered on case to case basis.<br />‍</div>
			<div class="ln-bd-txt"><strong>Bachelor&#x27;s or Bachelor&#x27;s (Honours) Degree<br />﻿﻿ <br /></strong>• Minimum of 160 credits﻿﻿<strong> <br /></strong>• At least 4 years of post-K-12 study<br />﻿﻿• Any major or discipline accepted</div>
		</div>
	</div>
</section>
<section id="fee-structure" class="section">
	<div class="container">
		<div class="head-wrap top">
			...
			</div><a Data-id="" data-wf--button-regular--variant="base" href="https://atlasuniversity.edu.in/mdes/feestructure" target="_blank" class="button-regular w-inline-block">
				<div data-wf--button-space--variant="normal" class="extra-space">
			...
			<div class="df-container isdi">
				<div class="df-card blue isdi-pink">
					...
					<div class="df-txt-wrap">
						<div class="df-text-1"><strong>2 Years</strong><br /></div>
				...
				<div class="df-card">
					...
					<div class="df-text-1"><strong class="fee-dates">5,77,500</strong></div>
				</div>
			</div>
		</div>
	</div>
...
include "../../../../assets/include/faq/isdi/admissions/pg-mdes.php" ?>
