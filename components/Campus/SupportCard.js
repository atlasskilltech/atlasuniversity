...
/**
 * `.career-sup-card.ugdx` — a photograph over an indigo copy panel, used twice
 * on /campus-atlas: "Startup Incubators" (`campus-atlas.php:222-249`) and the
 * three residence cards inside "Live Where You Learn"
 * (`campus-atlas.php:261-288`).
 *
 * ── Measured cascade ──────────────────────────────────────────────────────
 *                            >=768px                    <=767px
