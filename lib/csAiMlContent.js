...
export const hero = {
  ...
  image: {
    src: '/assets/images/programs/hero/cs-ai-ml-ds-hero.png',
    srcSet:
      '/assets/images/programs/hero/cs-ai-ml-ds-hero-p-500.png 500w, '
      + '/assets/images/programs/hero/cs-ai-ml-ds-hero-p-800.png 800w, '
      + '/assets/images/programs/hero/cs-ai-ml-ds-hero-p-1080.png 1080w, '
      + '/assets/images/programs/hero/cs-ai-ml-ds-hero.png 1366w',
