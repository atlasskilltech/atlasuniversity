...
export const utilityLinks = [
  ...
  /* the reference's top bar hard-codes the absolute production URL where the
     Advantages menu writes the same route through `$domain`; the route is this
     site's own and is built, so both point at it */
